...
public class LoggedMapFragment extends MapFragment implements OnMapReadyCallback {
     ...
     * @param cursor
     */
    private void handleCamera(Cursor cursor) {
        // 位置情報がない場合には、何もしない
        ...
        if(places.size() == 1){
            ...
            CameraUpdate update = CameraUpdateFactory.newLatLngBounds(displayBounds,padding);
